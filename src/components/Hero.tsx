  ...
  return (
    <section className="hero-section relative flex flex-col items-center justify-center w-full min-h-[90vh] bg-background text-foreground overflow-hidden pt-40 pb-20 px-4">
      ...
      <div className="relative w-full max-w-2xl h-72 mb-20 flex items-center justify-center z-20 bg-transparent">
        ...
        <Link
          to="/hemsidor-sala"
          className="absolute top-[15%] right-[22%] flex flex-col items-center group cursor-pointer z-50 p-3 rounded-xl hover:bg-card/5 transition-all duration-300"
        ...
        <Link
          to="/seo-koping"
          className="absolute top-[50%] left-[15%] flex flex-col items-center group cursor-pointer z-50 p-3 rounded-xl hover:bg-card/5 transition-all duration-300"
        ...
        <Link
          ...
          className="absolute top-[55%] right-[22%] flex flex-col items-center group cursor-pointer z-50 p-3 rounded-xl hover:bg-card/5 transition-all duration-300"
