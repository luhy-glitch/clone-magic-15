  ...
  return (
    <section className="hero-section relative flex flex-col items-center justify-center w-full min-h-[90vh] bg-[#050810] text-white overflow-hidden pt-40 pb-20 px-4">
      ...
      <div className="relative w-full max-w-2xl h-72 mb-20 flex items-center justify-center z-20 bg-transparent">
        ...
        <Link
          to="/hemsidor-sala"
          className="absolute top-[15%] right-[30%] flex flex-col items-center group cursor-pointer z-50 p-3 -m-3 rounded-xl hover:bg-white/[0.05] transition-all duration-300"
        >
          <div className="relative">
            <div className="w-4 h-4 bg-yellow-500 rounded-full shadow-[0_0_20px_#eab308] animate-city-pulse group-hover:scale-150 transition-transform duration-300" />
          ...
          <span className="text-xs mt-2 text-gray-400 group-hover:text-white transition-colors font-medium underline-offset-2 group-hover:underline">Sala</span>
        </Link>

        {/* Köping */}
        <Link
          to="/seo-koping"
          className="absolute bottom-[28%] left-[22%] flex flex-col items-center group cursor-pointer z-50 p-3 -m-3 rounded-xl hover:bg-white/[0.05] transition-all duration-300"
        >
          <div className="relative">
            <div className="w-4 h-4 bg-yellow-500 rounded-full shadow-[0_0_20px_#eab308] animate-city-pulse [animation-delay:0.8s] group-hover:scale-150 transition-transform duration-300" />
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 px-3 py-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg text-xs text-white whitespace-nowrap opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100 transition-all duration-200 pointer-events-none">
              SEO-optimering i Köping
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-white/10 border-r border-b border-white/20 rotate-45 -mt-1"></div>
            </div>
          </div>
          <span className="text-xs mt-2 text-gray-400 group-hover:text-white transition-colors font-medium underline-offset-2 group-hover:underline">Köping</span>
        </Link>

        {/* Västerås */}
        <Link
          to="/webbutveckling-vasteras"
          className="absolute bottom-[22%] right-[28%] flex flex-col items-center group cursor-pointer z-50 p-3 -m-3 rounded-xl hover:bg-white/[0.05] transition-all duration-300"
        >
          <div className="relative">
            <div className="w-4 h-4 bg-yellow-500 rounded-full shadow-[0_0_20px_#eab308] animate-city-pulse [animation-delay:1.6s] group-hover:scale-150 transition-transform duration-300" />
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 px-3 py-2 bg-white/10 backdrop-blur-xl border border-white/20 rounded-lg text-xs text-white whitespace-nowrap opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100 transition-all duration-200 pointer-events-none">
              Webbutveckling i Västerås
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-2 h-2 bg-white/10 border-r border-b border-white/20 rotate-45 -mt-1"></div>
            </div>
          </div>
          <span className="text-xs mt-2 text-gray-400 group-hover:text-white transition-colors font-medium underline-offset-2 group-hover:underline">Västerås</span>
        </Link>
        ...
        <div className="relative z-20 -translate-y-10">
          ...
          <Link
            ...
            className="relative bg-gradient-to-r from-amber-500 via-yellow-500 to-amber-400 text-black px-8 py-4 rounded-full font-bold flex items-center gap-2 shadow-[0_0_40px_rgba(245,158,11,0.4)] hover:shadow-[0_0_60px_rgba(245,158,11,0.6)] hover:scale-105 transition-all animate-cta-pulse"
          >
