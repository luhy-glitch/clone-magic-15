        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <nav aria-label="Övrigt">
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/blogg/komplett-seo-guide-smaforetag" className="text-sm text-muted-foreground hover:text-primary transition-colors">SEO-guide småföretag</Link></li>
              <li><Link to="/blogg/skapa-hemsida-foretag-guide" className="text-sm text-muted-foreground hover:text-primary transition-colors">Skapa hemsida guide</Link></li>
              <li><Link to="/blogg/oka-hemsidans-hastighet" className="text-sm text-muted-foreground hover:text-primary transition-colors">Öka hemsidans hastighet</Link></li>
              <li><Link to="/blogg/lokal-seo-smaforetag" className="text-sm text-muted-foreground hover:text-primary transition-colors">Lokal SEO</Link></li>
              <li><Link to="/blogg/react-vs-wordpress" className="text-sm text-muted-foreground hover:text-primary transition-colors">React vs WordPress</Link></li>
            </ul>
          </nav>
        </div>
