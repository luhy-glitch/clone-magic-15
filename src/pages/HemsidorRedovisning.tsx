...
const config = {
  ...
  icon: ShieldCheck,
  heroFacts: [
    "Professionell design som stärker förtroende", 
    "Säkra klientportaler och dokumenthantering", 
    "Lokal SEO för sökningar som 'redovisningsbyrå Västmanland'", 
    "Hög prestanda och tillgänglighet för klienter och team",
  ],
  benefits: [
    { title: "Trovärdigheten börjar på webben", description: "Vi hjälper din byrå att framstå som professionell och pålitlig redan vid första besöket på hemsidan." },
    { title: "Klientportaler och dokument", description: "Smidiga portaler för löneunderlag, fakturor och rapporter som känns säkra och lätta att använda." },
    { title: "Lokal SEO för redovisningsbyråer", description: "Vi optimerar för termer som 'redovisning Västerås' och 'bokföringsbyrå Köping' så att du syns när kunder letar efter hjälp." },
  ...
  bodyExtraSections: [
    {
      ...
      paragraphs: [
        "En redovisningsbyrå byggs på förtroende. Din hemsida måste spegla det genom en professionell design, tydliga case-studier och kundreferenser. Vi hjälper dig att presentera dina kunder (med deras tillstånd), visa upp resultat och beskriva processer på ett sätt som inger förtroende.",
        "Klar och koncis kommunikation är viktigt. Vi strukturerar hemsidan så att besökaren omedelbart ser vilka tjänster du erbjuder, vad processen är och hur de kan ta kontakt. Det minskar osäkerhet och ökar chansen att de tar första steget – att boka ett möte.",
        "Vi använder visuella element som ikoner, tabeller och scheman för att göra komplex information lätt att ta till sig. Det här skapar en känsla av trygghet och transparens, vilket är avgörande för företag som vill anlita en redovisningsbyrå.",
      ],
    },
    {
      title: "Klientportal och säkra dokumentflöden",
      paragraphs: [
        "Moderna redovisningsbyråer använder klientportaler för att hantera dokument, kommunikation och uppföljning. Vi bygger lösningar där dina kunder kan logga in, ladda upp underlag, se status på sina ärenden och hämta rapporter – allt i en säker miljö.",
        "Vi integrerar gärna med system du redan använder, som Fortnox eller Visma, eller skapar ett enklare portalgränssnitt där du manuellt hanterar ärenden. Oavsett vilket, levererar vi en användarupplevelse som känns professionell och trygg.",
        "Säkerhet är centralt. Allt material hanteras över HTTPS, filer krypteras och åtkomst loggas. Det ger både dig och dina kunder sinnesro, och det visar tydligt att du tar sekretess på allvar.",
      ],
    },
    {
      title: "Lokal SEO för redovisningsbyråer i Västmanland",
      paragraphs: [
        "Att ranka för sökningar som 'redovisning Västerås' eller 'bokföringsbyrå Sala' kräver lokal förankring. Vi skapar landningssidor som vänder sig till företag i ditt geografiska område och optimerar dem med lokal information, klientreferenser och lokala nyckelord.",
        "Vi implementerar Schema.org LocalBusiness och AccountingService-schema för att hjälpa Google förstå vilka tjänster du erbjuder och var du är verksam. Det ökar chansen för rika utdrag och kartpaketplaceringar i sökresultaten.",
        "Vi hjälper dig också att optimera Google Business-profilen med rätt kategori, tjänstebeskrivningar, kontaktuppgifter och öppettider. En komplett profil gör det enklare för potentiella kunder att hitta och kontakta dig direkt från sökresultatet.",
      ],
    },
    {
      title: "Redovisningsbyråer i Västmanland som vill växa",
      paragraphs: [
        "Många redovisningsbyråer växer genom rekommendationer, men den digitala närvaron har blivit allt viktigare. Kunder börjar sin sökning online, och en professionell hemsida gör att du fångar upp dem tidigt i processen.",
        "Genom att kombinera en stabil teknisk grund med relevant innehåll och ett tydligt erbjudande kan du attrahera både småföretagare och större kunder. Vi hjälper dig formulera en hemsida som förmedlar vad som gör din byrå unik – oavsett om du fokuserar på e-handelsbokföring, löneadministration eller rådgivning.",
        "För byråer som vill utöka sitt erbjudande erbjuder vi också möjligheten att skapa separata landningssidor för specifika tjänster, som 'löneoutsourcing' eller 'bokslut och årsredovisning'. Det ger fler ingångar för sök och bättre chanser att landa i relevanta sökresultat.",
      ],
    },
  ],
  caseStudy: {
  ...
  faq: [
    ...
    { question: "Vad händer om jag redan har en hemsida men den är gammal?", answer: "Vi kan antingen uppgradera din befintliga sajt eller bygga en ny från grunden. Ofta är en ny modern lösning mer kostnadseffektiv på sikt." },
  ],
};
