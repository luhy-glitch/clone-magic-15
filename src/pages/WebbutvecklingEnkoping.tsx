...
const config = {
  ...
  metaTitle: "Webbutveckling & SEO Enköping | Modern Hemsida med 100/100 PageSpeed",
  metaDescription: "Professionell webbutveckling och SEO i Enköping. React & Next.js-sajter med 100/100 PageSpeed som konverterar besökare till kunder. Boka fri konsultation!",
