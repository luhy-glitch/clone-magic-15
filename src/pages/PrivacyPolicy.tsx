  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12 sm:py-20">
        ...
        <div className="prose prose-neutral max-w-none space-y-6 text-foreground/90 text-sm sm:text-base leading-relaxed">
          <p>
          ...
          <h2 className="text-xl font-bold text-foreground mt-8">4. Dina rättigheter</h2>
          ...
          <p className="text-muted-foreground mt-8 text-xs">Senast uppdaterad: februari 2026</p>
        </div>
      </div>
    </div>
  );
