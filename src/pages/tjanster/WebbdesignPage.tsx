...
const WebbdesignPage = () => (
  <ServicePageTemplate
    title="Webbdesign"
    metaTitle="Webbdesign & UX-design Västmanland | LRH Konsult"
    metaDescription="Professionell webbdesign som engagerar besökare och driver konverteringar. Letar du efter en designbyrå i Västerås? Vi skapar snygga hemsidor med 100/100 prestanda."
    heroSubheading="Webbdesign"
    heroHeading="Webbdesign som engagerar & konverterar"
    heroDescription="Letar du efter en modern designbyrå i Västerås eller Västmanland? Din webbplats är ditt digitala skyltfönster. Vi levererar en snygg hemsida som kombinerar estetik med knivskarp affärsnytta. För lokala företag skapar vi unika digitala identiteter som stärker varumärket, bygger förtroende och driver konverteringar – allt med 100/100 i PageSpeed."
    whyTitle="Din lokala partner för webbdesign i Västerås & Västmanland"
    whyText="Vi fokuserar på UX (användarupplevelse) för att säkerställa att din företagsdesign är lättnavigerad och intuitiv. En riktigt snygg hemsida ska inte bara se bra ut – den ska leda kunden direkt till köp eller kontakt. Oavsett om du finns i Västerås, Sala eller Köping baserar vi varje designbeslut på data och beprövade konverteringsstrategier anpassade för den lokala marknaden."
    icon={Palette}
    breadcrumbLabel="Webbdesign"
    features={[
      { title: "UI/UX & Företagsdesign", description: "Vi skapar en snygg och säljande hemsida som får ditt företag att sticka ut. Användarvänliga gränssnitt baserade på research för maximal konvertering." },
    ...
    faq={[
      { question: "Vad är UI/UX-design och varför är det viktigt?", answer: "UI (användargränssnitt) och UX (användarupplevelse) handlar om hur din sajt ser ut och fungerar. En bra företagsdesign ser till att besökare enkelt hittar vad de letar efter och konverterar till kunder." },
      ...
      { question: "Vad kostar en professionell webbdesign?", answer: "Priset varierar beroende på omfattning och komplexitet. Som din lokala webbyrå erbjuder vi alltid skräddarsydda offerter anpassade för småföretag i Västmanland, med transparenta priser utan dolda kostnader." },
    ...
    contentSections={[
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Resultatet är webbplatser som inte bara ser fantastiska ut utan som konsekvent uppnår 100/100 i Google PageSpeed Insights. För företag i Västerås och övriga Västmanland innebär detta en dubbel fördel: en design som imponerar på besökare och en teknisk prestanda som imponerar på Google. Den kombinationen av estetik och hastighet är vad som skapar en verklig konkurrensfördel i dagens digitala landskap.",
        ],
      },
      {
        title: "Fler frågor om att anlita en designbyrå",
        paragraphs: [
