...
const WebbdesignPage = () => (
  <ServicePageTemplate
    ...
    metaDescription="Professionell webbdesign som engagerar besökare och driver konverteringar. Modern UX-design med 100/100 prestanda för företag i Västmanland."
