...
const WebbutvecklingPage = () => (
  <ServicePageTemplate
    ...
    whyTitle="Webbutveckling med fokus på Next.js & React"
    whyText="Genom att använda världsledande teknik ser vi till att ditt företag får en teknisk fördel. Våra lösningar laddar på under en sekund, vilket är ett krav för att nå förstaplatsen på Google under 2026. Vi kombinerar teknisk expertis med affärsförståelse för att bygga webbplatser som driver verklig tillväxt."
    icon={Code2}
    breadcrumbLabel="Webbutveckling"
    features={[
      { title: "React & Next.js", description: "Moderna ramverk som levererar snabba, interaktiva webbplatser med server-side rendering för bästa möjliga SEO och användarupplevelse." },
      { title: "Responsiv design", description: "Pixel-perfekt upplevelse på alla skärmstorlekar – från mobil till desktop. Mobile-first-approach som standard." },
      { title: "API-integrationer", description: "Sömlös koppling till betalningssystem, CRM, bokningssystem och andra tredjepartstjänster som din verksamhet kräver." },
      { title: "E-handelslösningar", description: "Skräddarsydda webshop-lösningar med säker betalning, produkthantering och smidig orderhantering." },
      { title: "Prestanda & Säkerhet", description: "Optimerad kod, HTTPS, CSP-headers och regelbundna säkerhetsgranskningar ingår som standard i varje projekt." },
    ]}
    process={[
      { step: "1", title: "Behovsanalys & strategi", description: "Vi börjar med att förstå ditt företag, era mål och er målgrupp i Västmanland. Tillsammans tar vi fram en strategi och en tydlig projektplan med milstolpar." },
      { step: "2", title: "Design & prototyp", description: "Vi skapar wireframes och interaktiva prototyper som du kan testa innan en enda rad kod skrivs. Du godkänner designen innan vi går vidare till utveckling." },
