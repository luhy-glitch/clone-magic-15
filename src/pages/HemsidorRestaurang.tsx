...
const config = {
  ...
  heroFacts: [
    "100/100 PageSpeed – snabbaste restaurangsidorna i Västmanland",
    "Responsiva menyer som rankar i Google – inga PDF:er",
    "Online-bokning utan provision till tredjepartstjänster",
    "JSON-LD Restaurant-schema för bättre synlighet i sökresultaten",
  ],
  benefits: [
    { title: "Mobilanpassad meny", description: "Responsiva menyer som läses direkt i mobilen utan att behöva scrolla eller zooma – eftersom de är byggda i HTML och indexeras av Google." },
    { title: "Bokningssystem som konverterar", description: "Onlinebokning direkt i hemsidan utan dyra provisioner. Vi optimerar flödet för att få konverteringar från första klicket." },
    { title: "Lokal SEO för restauranger", description: "Vi optimerar din webbplats för söktermer som 'restaurang Västmanland', 'lunch Västerås' och 'boka bord Köping' med schema, metadata och lokal landningssida." },
  ...
  bodyExtraSections: [
    {
      ...
      paragraphs: [
        "Bokningsplattformar tar ofta 10–20% i provision per bokning. För en restaurang som gör 20 bokningar per vecka kan det bli en betydande kostnad. Vi bygger bokningssystem direkt i din hemsida som inte tar någon provision – det är en investering som snabbt betalar sig.",
        "Bokningsflödet designas för att minimera avhopp. Vi använder tydliga call-to-actions, smarta formulärvalideringar och en mobilvänlig design som gör det enkelt att boka med ett fåtal tryck. Du kan även styra hur mycket information du vill samla in – från endast namn och telefonnummer till fler val som särskilda önskemål eller allergier.",
        "För restauranger som vill synka bokningar med sitt POS-system eller kalendrar finns det möjlighet att koppla via API:er eller enklare export/importflöden. Målet är att ge dig full kontroll utan onödig komplexitet.",
      ],
    },
    {
      title: "Responsiva menyer som rankar i Google",
      paragraphs: [
        "Menyer är det viktigaste innehållet på en restaurangs hemsida, men de indexeras sällan om de ligger inbäddade som PDF. Genom att bygga menyer med semantisk HTML och Schema.org Menu-schema kan vi få dina rätter att dyka upp i sökresultaten på sökningar som 'vegan pizza Västmanland' eller 'lunch buffé Köping'.",
        "Vi designar menyer som är lätta att skanna på mobilen, med tydliga sektioner, priser och allergeninformation. Menyn kan uppdateras enkelt via ett CMS eller ett admin-gränssnitt så att du kan hålla den aktuell utan att behöva kontakta utvecklaren varje gång.",
        "Vi optimerar även för bilder i menyn – från förrätt till dessert. Rätterna laddar snabbt med AVIF och lazy-loading, samtidigt som de ser aptitliga ut på alla enheter. Det gör att dina gäster har en positiv upplevelse redan innan de bokar bord.",
      ],
    },
    {
      title: "Lokal SEO för restaurang i Västmanland",
      paragraphs: [
        "Lokal SEO handlar om mer än bara sökord – det handlar om att bygga förtroende hos gäster i ditt område. Vi optimerar din Google Business-profil, lägger till rätt kategori, öppettider, meny och bilder, och arbetar kontinuerligt med att samla äkta kundrecensioner.",
        "På hemsidan implementerar vi JSON-LD Restaurant-schema, LocalBusiness-schema och FAQ-schema för att öka sannolikheten att din restaurang visas med rika utdrag i sökresultaten. Det gör att din sida sticker ut och får fler klick – särskilt för sökningar som 'boka bord Sala' eller 'restaurang Västmanland'.",
        "Genom att skapa lokalt inriktat innehåll – till exempel 'Veckans lunch i Västerås' eller 'Säsongens meny i Köping' – kan vi fånga upp säsongsspecifika sökningar och hålla din sajt relevant året runt. Det ger en stabil trafikökning och fler bokningar.",
      ],
    },
    {
      title: "Restauranger i Västmanland som vinner online",
      paragraphs: [
        "Många restauranger i Västmanland förlitar sig på sociala medier eller externa bokningsplattformar. Det ger dem begränsad kontroll över sina kundrelationer och gör dem sårbara för förändringar i plattformarnas villkor. En egen hemsida ger dig full kontroll över ditt innehåll, din data och din kundupplevelse.",
        "Vi har jobbat med restauranger av alla storlekar – från små lunchställen i Köping till fullservicerestauranger i Västerås. Oavsett om du vill öka lunchförsäljningen, fylla borden på vardagskvällar eller öka antalet återkommande gäster, hjälper vi dig att skapa en hemsida som levererar resultat.",
        "Det handlar inte bara om att synas – det handlar om att tydligt kommunicera vad som gör din restaurang unik. Vi hjälper dig att lyfta fram din meny, din atmosfär och din service så att gästerna vet varför de ska välja just dig.",
      ],
    },
  ],
  caseStudy: {
