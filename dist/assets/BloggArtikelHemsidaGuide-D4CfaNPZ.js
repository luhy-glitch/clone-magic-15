...
`,R=()=>{const i=T(k),o=E(k),n=`${N}${P}`;return e.jsxs("div",{className:"min-h-screen",children:[e.jsx(b,{title:`${l} | LRH Konsult`,description:m}),e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify({"@context":"https://schema.org","@type":"BlogPosting",headline:l,description:m,datePublished:"2026-03-16",dateModified:"2026-03-16",image:{"@type":"ImageObject",url:"https://www.lrhkonsult.se/og-image.jpg",width:1200,height:630},author:{"@type":"Person",name:"Lucas",url:"https://www.lrhkonsult.se/om-mig"},publisher:{"@type":"Organization",name:"LRH Konsult",url:"https://www.lrhkonsult.se",logo:{"@type":"ImageObject",url:"https://www.lrhkonsult.se/og-image.jpg",width:1200,height:630}},mainEntityOfPage:{"@type":"WebPage","@id":n},wordCount:k.split(/\s+/).length,inLanguage:"sv"})}}),e.jsx(v,{}),e.jsxs("main",{children:[e.jsx("section",{className:"bg-hero text-hero-foreground pt-20 pb-12 sm:pb-16",children:e.jsxs("div",{className:"max-w-3xl mx-auto px-4 sm:px-6",children:[e.jsx(S,{className:"mb-8",children:e.jsxs(w,{children:[e.jsx(g,{children:e.jsx(h,{asChild:!0,children:e.jsx(p,{to:"/",className:"text-hero-muted hover:text-primary",children:"Hem"})})}),e.jsx(u,{}),e.jsx(g,{children:e.jsx(h,{asChild:!0,children:e.jsx(p,{to:"/blogg",className:"text-hero-muted hover:text-primary",children:"Blogg"})})}),e.jsx(u,{}),e.jsx(g,{children:e.jsx(A,{className:"text-hero-foreground truncate max-w-[200px] sm:max-w-none",children:l})})]})}),e.jsxs(j,{children:[e.jsx("h1",{className:"text-3xl sm:text-4xl md:text-5xl font-bold leading-tight",children:l}),e.jsx("p",{className:"mt-5 text-base sm:text-lg text-hero-muted max-w-2xl",children:m}),e.jsxs("div",{className:"mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-sm text-muted-foreground",children:"Lästid"}),e.jsxs("span",{className:"text-foreground font-semibold",children:[o," min"]})]}),e.jsx(y,{url:n,title:l})]})]})]})}),e.jsx("section",{className:"py-14 sm:py-20 bg-section-alt",children:e.jsx("div",{className:"max-w-4xl mx-auto px-4 sm:px-6",children:e.jsx("div",{className:"grid gap-12",children:i.map((r,a)=>{switch(r.type){case"h2":return e.jsx("h2",{id:r.id,className:"text-2xl font-bold",children:r.text},a);case"h3":return e.jsx("h3",{className:"text-xl font-semibold",children:r.text},a);case"quote":return e.jsx("blockquote",{className:"border-l-4 border-primary pl-4 italic text-muted-foreground",children:r.text},a);case"li":return e.jsx("li",{className:"ml-6 list-disc text-foreground",children:c(r.text)},a);case"p":default:return e.jsx("p",{className:"text-base leading-relaxed text-foreground",children:c(r.text)},a)}})})})})]}),e.jsx(x,{})]})};export{R as default};
