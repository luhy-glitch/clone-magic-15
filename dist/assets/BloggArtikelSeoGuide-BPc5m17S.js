import{j as e}from"./ui-vendor-CUvJdy9K.js";import{L as u}from"./react-vendor-CSY-tL5Y.js";import{P as v,N as b}from"./index-DyPNGGya.js";import{F as x}from"./Footer-BZmedBx4.js";import{A as j}from"./AnimatedSection-01g3Hqv0.js";import{S as y}from"./SocialShare-yYTRIQLA.js";import{B as S,a as E,b as m,c as h,d as c,e as O}from"./breadcrumb-P9j4e-bF.js";import"./phone-98tj_crn.js";import"./index-wnGSTn9f.js";import"./utils-BLSKlp9E.js";const w="https://www.lrhkonsult.se";function N(i){return Math.max(1,Math.ceil(i.split(/\s+/).length/200))}function A(i){const o=i.split(`
`),n=[];let t=[];const a=()=>{t.length>0&&(t.forEach(d=>n.push({type:"li",text:d})),t=[])};for(const d of o){const r=d.trim();if(!r){a();continue}if(r.startsWith("## ")){a();const s=r.slice(3),f=s.toLowerCase().replace(/[^a-zåäö0-9]+/g,"-").replace(/-+$/,"");n.push({type:"h2",text:s,id:f})}else if(r.startsWith("### "))a(),n.push({type:"h3",text:r.slice(4)});else if(r.startsWith("> "))a(),n.push({type:"quote",text:r.slice(2)});else if(r.startsWith("- ")||r.startsWith("* "))t.push(r.slice(2));else{a();const s=n[n.length-1];s&&s.type==="p"?s.text+=" "+r:n.push({type:"p",text:r})}}return a(),n}function p(i){return i.split(/(\[[^\]]+\]\([^\)]+\))/g).map((n,t)=>{const a=n.match(/^\[([^\]]+)\]\(([^)]+)\)$/);return a?e.jsx(u,{to:a[2],className:"text-primary hover:underline underline-offset-2 font-medium",children:a[1]},t):n.split(/(\*\*[^*]+\*\*)/g).map((r,s)=>r.startsWith("**")&&r.endsWith("**")?e.jsx("strong",{className:"text-foreground font-semibold",children:r.slice(2,-2)},`${t}-${s}`):e.jsx("span",{children:r},`${t}-${s}`))})}const l="Komplett SEO-guide för småföretag 2025",g="Komplett SEO-guide för småföretag i Västerås och Västmanland – från nyckelordsanalys och on-page till lokal SEO och länkbygge. Så syns du högre på Google.",T="/blogg/seo-vasteras-guide",k=`
...
`,C=()=>{const i=A(k),o=N(k),n=`${w}${T}`;return e.jsxs("div",{className:"min-h-screen",children:[e.jsx(v,{title:`${l} | LRH Konsult`,description:g}),e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify({"@context":"https://schema.org","@type":"BlogPosting",headline:l,description:g,datePublished:"2026-03-16",author:{"@type":"Person",name:"Lucas",url:"https://www.lrhkonsult.se/om-mig"},publisher:{"@type":"Organization",name:"LRH Konsult",url:"https://www.lrhkonsult.se"},mainEntityOfPage:n,wordCount:k.split(/\s+/).length,inLanguage:"sv"})}}),e.jsx(b,{}),e.jsxs("main",{children:[e.jsx("section",{className:"bg-hero text-hero-foreground pt-20 pb-12 sm:pb-16",children:e.jsxs("div",{className:"max-w-3xl mx-auto px-4 sm:px-6",children:[e.jsx(S,{className:"mb-8",children:e.jsxs(E,{children:[e.jsx(m,{children:e.jsx(h,{asChild:!0,children:e.jsx(u,{to:"/",className:"text-hero-muted hover:text-primary",children:"Hem"})})}),e.jsx(c,{}),e.jsx(m,{children:e.jsx(h,{asChild:!0,children:e.jsx(u,{to:"/blogg",className:"text-hero-muted hover:text-primary",children:"Blogg"})})}),e.jsx(c,{}),e.jsx(m,{children:e.jsx(O,{className:"text-hero-foreground truncate max-w-[200px] sm:max-w-none",children:l})})]})}),e.jsxs(j,{children:[e.jsx("h1",{className:"text-3xl sm:text-4xl md:text-5xl font-bold leading-tight",children:l}),e.jsx("p",{className:"mt-5 text-base sm:text-lg text-hero-muted max-w-2xl",children:g}),e.jsxs("div",{className:"mt-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between",children:[e.jsxs("div",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-sm text-muted-foreground",children:"Lästid"}),e.jsxs("span",{className:"text-foreground font-semibold",children:[o," min"]})]}),e.jsx(y,{url:n,title:l})]})]})]})}),e.jsx("section",{className:"py-14 sm:py-20 bg-section-alt",children:e.jsx("div",{className:"max-w-4xl mx-auto px-4 sm:px-6",children:e.jsx("div",{className:"grid gap-12",children:i.map((t,a)=>{switch(t.type){case"h2":return e.jsx("h2",{id:t.id,className:"text-2xl font-bold",children:t.text},a);case"h3":return e.jsx("h3",{className:"text-xl font-semibold",children:t.text},a);case"quote":return e.jsx("blockquote",{className:"border-l-4 border-primary pl-4 italic text-muted-foreground",children:t.text},a);case"li":return e.jsx("li",{className:"ml-6 list-disc text-foreground",children:p(t.text)},a);case"p":default:return e.jsx("p",{className:"text-base leading-relaxed text-foreground",children:p(t.text)},a)}})})})})]}),e.jsx(x,{})]})};export{C as default};
